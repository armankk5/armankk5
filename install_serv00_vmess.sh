...
menu() {
   ...
   echo -e "${green}脚本地址：${re}${yellow}https://github.com/armankk5${re}\n"
   echo -e "${green}博客：${re}${yellow}https://www.youtube.com/@armankk5${re}\n"
   echo -e "${green}TG反馈群组：${re}${yellow}[https://t.me/AM_CLUBS](https://t.me/Msv2flyNG)${re}\n"
